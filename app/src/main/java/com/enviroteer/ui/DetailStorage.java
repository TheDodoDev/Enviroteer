...
public class DetailStorage {
    ...
    public DetailStorage() {
        ...
        details.add(new Detail("Chovar Will Be Green Again!", "Chovar has lost its greenary in the last few years. Shall we make it green again?","Chovar, Nepal", "19/08/2023","10:00", "18:00"));
    }
